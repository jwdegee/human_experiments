...
if __name__ == '__main__':
    ...
    my_sess = GaborSession(output_str='{}_{}_{}'.format(subject_nr, block_nr, dt), output_dir='data/0_staircase', settings_file=settings, task='diagonal_cardinal', n_trials=200, awake=awake) #Set and run a session
    my_sess.run()
