...
class TestTrial(Trial):
    ...
    def __init__(self, session, trial_nr, phase_durations, parameters, **kwargs):
        ...
        self.stimulus_pulse_started = False
        self.stimulus_pulse_ended = False
    ...
    def draw(self):
        ...
        if self.phase == 1: # delay
            ...
            if not self.stimulus_pulse_ended:
                port.write(b'0')
                self.stimulus_pulse_ended  = True
        ...
        if self.phase == 2: # stimulus
            ...
            if 'freq' in self.parameters:
                ...
                if not self.stimulus_pulse_started:
                    port.write(b'1')
                    self.stimulus_pulse_started  = True
